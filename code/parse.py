...
def parse_args():
    parser = argparse.ArgumentParser(description="debias_train_loss")
    parser.add_argument('--data_path', type=str, default='../data', help="data path")
    parser.add_argument('--data_name', type=str, default='coat', help="data name")
    ...
    parser.add_argument('--debias_name', type=str, default='erm', help='ncf')
    parser.add_argument('--pred_model_name', type=str, default='ncf', help='ncf')
    parser.add_argument('--impu_model_name', type=str, default='ncf', help='ncf')
    parser.add_argument('--prop_model_name', type=str, default='logistic_regression', help='ncf')
    parser.add_argument('--non_linear', type=str, default='relu', help='non_linear')
    parser.add_argument('--final_bias', type=int, default=1, help='final_bias')
    ...
    parser.add_argument('--batch_size_prop', type=int, default=1024, help='batch size')
    ...
    parser.add_argument('--share_lr', type=float, default=0.01, help='weight decay for learning model_share')
    parser.add_argument('--share_lamb', type=float, default=0.0, help='weight decay for learning model_share')
